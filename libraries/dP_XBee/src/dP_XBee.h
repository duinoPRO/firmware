...
class dP_XBee : public Module {
  ...
  public:
	...
	*/
	...
	/** \brief Retrieve the duinoPRO module corresponding to the dP_XBee module's lower location number.
	 *  \return The duinoPRO module.
	 */
	...
	*/
	 ...
	 *  \param txLen - The length of txPkt.
